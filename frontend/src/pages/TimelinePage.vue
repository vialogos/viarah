...
import { getMembershipRoleForOrg, isClientOnlyMemberships } from "../routerGuards";
...
const currentRole = computed(() => (context.orgId ? getMembershipRoleForOrg(session.memberships, context.orgId) : ""));
